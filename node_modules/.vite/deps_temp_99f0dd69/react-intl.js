  ...
  for (var _i = 0, tokens_1 = tokens; _i < tokens_1.length; _i++) {
    ...
    switch (token.stem) {
      ...
      case "KK":
        ...
        continue;
      case "scientific":
        result = __assign5(__assign5(__assign5({}, result), { notation: "scientific" }), token.options.reduce(function(all, opt2) {
          return __assign5(__assign5({}, all), parseNotationOptions(opt2));
        }, {}));
        continue;
      case "engineering":
        result = __assign5(__assign5(__assign5({}, result), { notation: "engineering" }), token.options.reduce(function(all, opt2) {
          return __assign5(__assign5({}, all), parseNotationOptions(opt2));
        }, {}));
        continue;
    ...
    if (FRACTION_PRECISION_REGEX.test(token.stem)) {
      ...
      if (opt === "w") {
        result = __assign5(__assign5({}, result), { trailingZeroDisplay: "stripIfInteger" });
      } else if (opt) {
        result = __assign5(__assign5({}, result), parseSignificantPrecision(opt));
      }
      continue;
    }
    if (SIGNIFICANT_PRECISION_REGEX.test(token.stem)) {
      result = __assign5(__assign5({}, result), parseSignificantPrecision(token.stem));
      continue;
    }
    var signOpts = parseSign(token.stem);
    if (signOpts) {
      result = __assign5(__assign5({}, result), signOpts);
    }
    var conciseScientificAndEngineeringOpts = parseConciseScientificAndEngineeringStem(token.stem);
    if (conciseScientificAndEngineeringOpts) {
      result = __assign5(__assign5({}, result), conciseScientificAndEngineeringOpts);
    }
  }
  return result;
}
    ...
    Parser2.prototype.parseArgumentOptions = function(nestingLevel, expectingCloseTag, value, openingBracePosition) {
      ...
      switch (argType) {
        ...
        case "select": {
          ...
          this.bumpSpace();
          if (!this.bumpIf(",")) {
            return this.error(ErrorKind.EXPECT_SELECT_ARGUMENT_OPTIONS, createLocation(typeEndPosition_1, __assign4({}, typeEndPosition_1)));
          }
          this.bumpSpace();
...
function parse(message, opts) {
  ...
  opts = __assign4({ shouldParseSkeletons: true, requiresOtherClause: true }, opts);
...
var FormatError = (
  /** @class */
  function(_super) {
    __extends4(FormatError2, _super);
...
var InvalidValueError = (
  /** @class */
  function(_super) {
    __extends4(InvalidValueError2, _super);
...
var InvalidValueTypeError = (
  /** @class */
  function(_super) {
    __extends4(InvalidValueTypeError2, _super);
...
var MissingValueError = (
  /** @class */
  function(_super) {
    __extends4(MissingValueError2, _super);
...
function mergeConfig(c1, c2) {
  ...
  return __assign3(__assign3(__assign3({}, c1 || {}), c2 || {}), Object.keys(c1).reduce(function(all, k) {
    all[k] = __assign3(__assign3({}, c1[k]), c2[k] || {});
    return all;
  }, {}));
}
...
function createDefaultFormatters(cache) {
  ...
  return {
    getNumberFormat: memoize(function() {
      ...
      return new ((_a2 = Intl.NumberFormat).bind.apply(_a2, __spreadArray3([void 0], args, false)))();
    }, {
    ...
    getDateTimeFormat: memoize(function() {
      ...
      return new ((_a2 = Intl.DateTimeFormat).bind.apply(_a2, __spreadArray3([void 0], args, false)))();
    }, {
    ...
    getPluralRules: memoize(function() {
      ...
      return new ((_a2 = Intl.PluralRules).bind.apply(_a2, __spreadArray3([void 0], args, false)))();
    }, {
  ...
  function() {
    function IntlMessageFormat2(message, locales, overrideFormats, opts) {
      ...
      if (typeof message === "string") {
        ...
        var _a2 = opts || {}, formatters = _a2.formatters, parseOpts = __rest2(_a2, ["formatters"]);
        this.ast = IntlMessageFormat2.__parse(message, __assign3(__assign3({}, parseOpts), { locale: this.resolvedLocale }));
      } else {
        this.ast = message;
      }
...
var UnsupportedFormatterError = (
  /** @class */
  function(_super) {
    __extends3(UnsupportedFormatterError2, _super);
...
var InvalidConfigError = (
  /** @class */
  function(_super) {
    __extends3(InvalidConfigError2, _super);
...
var MissingDataError = (
  /** @class */
  function(_super) {
    __extends3(MissingDataError2, _super);
...
var IntlFormatError = (
  /** @class */
  function(_super) {
    __extends3(IntlFormatError2, _super);
...
var MessageFormatError = (
  /** @class */
  function(_super) {
    __extends3(MessageFormatError2, _super);
...
var MissingTranslationError = (
  /** @class */
  function(_super) {
    __extends3(MissingTranslationError2, _super);
...
function createFormatters(cache) {
  ...
  return {
    ...
    getRelativeTimeFormat: memoize(function() {
      ...
      return new (RelativeTimeFormat.bind.apply(RelativeTimeFormat, __spreadArray2([void 0], args, false)))();
    }, {
    ...
    getListFormat: memoize(function() {
      ...
      return new (ListFormat.bind.apply(ListFormat, __spreadArray2([void 0], args, false)))();
    }, {
    ...
    getDisplayNames: memoize(function() {
      ...
      return new (DisplayNames.bind.apply(DisplayNames, __spreadArray2([void 0], args, false)))();
    }, {
...
function setTimeZoneInOptions(opts, timeZone) {
  return Object.keys(opts).reduce(function(all, k) {
    all[k] = __assign2({ timeZone }, opts[k]);
    return all;
  }, {});
}
function deepMergeOptions(opts1, opts2) {
  ...
  return keys.reduce(function(all, k) {
    all[k] = __assign2(__assign2({}, opts1[k] || {}), opts2[k] || {});
    return all;
  }, {});
}
...
function createIntl(config, cache) {
  ...
  return __assign2(__assign2({}, resolvedConfig), {
    formatters,
